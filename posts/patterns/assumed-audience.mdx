...
<AssumedAudience>
  ...
  collapse and the proliferation of generic articles that try to accomodate
...
All I can do it guess. I have to _assume_ things about you. Assumptions I make based off the other people my Twitter neighbourhood and extended gardening network.
...
A few examples to illutrate the point:
