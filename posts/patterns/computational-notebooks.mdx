...
This approach of interleaving documentation and source code is called [literate programming](https://en.wikipedia.org/wiki/Literate_programming). [Donald Knuth](https://en.wikipedia.org/wiki/Donald_Knuth) proposed it in 1984 as a solution to the burden of documenting code in environments divorced from the code itself. He argued that _all_ code should be written in these linear, readable documents. See Chris Granger's [Eve project](https://witheve.com/) for a beautiful example of mixing prose and code.
