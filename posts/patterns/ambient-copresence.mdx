...
<ImageFrame margin="1rem auto 3rem" src="/images/posts/ambient/medium-highlight.jpg" alt="A popular highlight on a Medium article" showalt width={960} />

Readers can also comment on these highlights, but these are hidden in a side panel and hard to read.

<ImageFrame margin="1rem auto 3rem" src="/images/posts/ambient/medium-highlight-2.jpg" alt="Comments on Medium highlights" showalt width={1200} />
