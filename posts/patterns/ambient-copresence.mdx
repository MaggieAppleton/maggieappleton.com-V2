...
<ImageFrame margin="2rem auto 4rem" src="/images/posts/ambient/linkedin.gif" width={1200} alt="Me having  deeply meaningful interactions with people on LinkedIn." showalt />
...
Our current digital attempt at this is the multiplayer cursor. Other people who have access to your file are visible in the interface as small, pointy, colourful cursors or text markers within a document, canvas, or spreadsheet. Sometimes with little names or floating profile pictures next to them to help identify people.
...
<ImageFrame src="/images/posts/ambient/multiplayer-cursor.jpg" width={1300} alt="Multiplayer cursors in Google Sheets showing which cells users have selected" showalt />
...
Hypothesis is a browser plugin that allows you to highlight and take notes on any content on the web. It works as an annotation layer over the internet. But one that everyone shares.
...
<ImageFrame margin="1rem auto 3rem" src="/images/posts/ambient/hypothesis.png" alt="Highlights and corresponding notes in the Hypothesis sidebar" showalt width={1300} />
...
The notoriously walled-off publishing platform [Medium]() implemented a similar feature on their articles. You can see the most popular highlights from other users. This feature is of course only available on their platform, which makes it remarkably less interesting or compelling.

<ImageFrame margin="1rem auto 3rem" src="/images/posts/ambient/hypothesis.png" alt="Popular highlights on a Medium article" showalt width={1300} />
