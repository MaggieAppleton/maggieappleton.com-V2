...
Many people have pointed to this lack of specific meaning behind the moniker. Here's an excerpt from a (paraphrased) [conversation](https://youtu.be/txGYG60TICA?t=411) between [Stewart Russell](https://en.wikipedia.org/wiki/Stuart_J._Russell) and [Sean Carroll](https://en.wikipedia.org/wiki/Sean_M._Carroll) on AI as a shifting continuum:
