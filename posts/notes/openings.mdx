---
title: "On Openings Essays, Conferences Talks, and Jam Jars"
...
To be clear, I make these mistakes too. I am a mediocre opener trying to become a good opener.
...
The change doesn't have to be _bad_ and the consequences aren't necessarily negative. It's simply that the state of the world has shifted, and there are knock-on effects that your community (a.k.a. your readers) should care about and explore solutions or responses to. These are changes they need to react to in some way, even if we don't yet have a clear solution.
...
Whether I can support that ending problem with solid evidence and argue for it convincingly is my job for the rest of the writing piece, but at least I've begun with a compelling problem.
...
I've been trapped in plenty of audiences where we're 10 minutes into an anecdote about the speaker's childhoods, and the whole room is desperately trying to figure out what The Point is. This is cruel and frustrating.

You should make The Point clear as soon as possible. Somewhere in the first minute I make sure to say:

- This talk is about X: a compelling problem with consequences for this audience
