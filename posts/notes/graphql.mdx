...
<TwoColumn GridColCount="3fr 4fr" gridGap="2em">
...
If you haven't heard of GraphQL, the TLDR is that it's a new way to request data from an API. <Sidenote idName={1}>If you're unsure what an API is, head on over to my illustrated article on [WTF is an API?](/api)</Sidenote>
...
<a noTip href="https://egghead.io/courses/graphql-query-language">
    <ImageFrame
        width="800px"
