...
description: "How to create nested timeslines in the Greensock animation library"
updated: "2020-10-18"
...
You can imagine my excitement when I discovered _nested timelines._ That's right, **timeline inception**.
