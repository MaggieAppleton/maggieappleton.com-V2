...
description: "Designing speculative calendar events to solve complex scheduling problems"
updated: "2024-01-08"
...
<ImageFrame src="/images/posts/speculative-events/chat1.png" />
<ImageFrame src="/images/posts/speculative-events/chat2.png" />
...
But real calendar events have real repercussions: my co-workers can't book calls with me at times when I have blocks on my calendar. My watch buzzes me 10 minutes before each one. My Mac pops a little notification reminder in the corner of my screen. Receiving notifications for not-real speculative events would be immensely frustrating.

<ImageFrame src="/images/posts/speculative-events/cal-notifs.png" width="1100px" margin="1rem auto 2rem" />
...
<ImageFrame src="/images/posts/speculative-events/spec-event.png" width="1200px" alt="A speculative calendar event marked with a dotted border, light opacity background, and question mark icon" />
...
<ImageFrame src="/images/posts/speculative-events/cron.jpg" width={685} alt="Selecting avaliable blocks in Cron" showalt />

<ImageFrame src="/images/posts/speculative-events/amie.png" width={915} alt="Booking an avaliable slot time in Amie" showalt />
...
<ImageFrame src="/images/posts/speculative-events/maybe2.jpg" alt="Maybe events on HEY calendar" />

<ImageFrame src="/images/posts/speculative-events/maybe.jpg" alt="Maybe events on HEY calendar" />
