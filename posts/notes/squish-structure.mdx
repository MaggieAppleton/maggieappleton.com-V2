...
description: "Slides and transcript from my talk on the challenges of designing with language models"
type: "note"
topics: ["Artificial Intelligence", "Anthropology", "Language Models", "The Web"]
updated: "2023-09-08"
...
Slides and transcript from my talk at [Smashing Conference](https://www.causalislands.com/) in Freiburg Germany, September 4th-5th, 2023. A video recording exists but is still being edited. Will add it here when it's ready.
...
<TalkSlide video imgSrc="/images/posts/squish-structure/playground.mp4">
