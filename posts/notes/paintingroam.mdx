...
<p>
  If I'm staring into something for over twenty hours a week, it better look and
  feel like beautiful home that fits my aesthetic tastes.{" "}
  <Footnote idName={2}>
    As a maker of aesthetically pleasing things, I'm obviously biased towards
    the{" "}
...
<p>
  ...
  >
    <button style={{ marginTop: "0.2em" }}>Intro to CSS on Khan Academy</button>{" "}
  </a>
</p>
