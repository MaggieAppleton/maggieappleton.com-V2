---
title: "Blocking out the Web: The Past, Present, and Future of Block-based Editors"
...
The places where we create these blocks have been christened _block-based editors_. They fall into two major categories; apps for creating personal and collaborative documents, including team wikis and note-taking applications. And “no-code” website builders that help people create blog posts and simple webpages. They're starting to replace to both classical word processors and syntax-based code files.

{graphic of blocks inside a document and a no code builder}

We're now in the middle of a Cambrian explosion of these editors. Blocks are a core concept in almost every modern document editor and no-code website builder; [Notion](https://www.notion.so/), [Wordpress Gutenberg](https://wordpress.org/gutenberg/), [Coda](https://coda.io/), [ClickUp](https://clickup.com/), [Craft](https://www.craft.do/), [Clover](https://cloverapp.co/), [Almanac](https://almanac.io/), [Microsoft Loop](https://www.microsoft.com/en-us/microsoft-loop?ms.url=microsoftcommicrosoft-loop), [Google Docs](https://docs.google.com/), [Kosmik](https://www.kosmik.app/), [Roam Research](https://roamresearch.com/), [Logseq](https://logseq.com/), [Remnote](https://www.remnote.com/), [Thunknotes](https://www.thunknotes.com/), [Clarity](https://www.clarity.so/), the list goes on.
...
At last count I found 25 block-editors in active development, and I've certainly missed some. Two more will get seed funding while you're reading this.
...
<h3 style={{ margin: "0.25rem 0 0.5rem" }}>
  Hotkey-triggered block picker menus
</h3>
...
This interaction pattern allows you to quickly browse and select blocks without moving your hands off the keyboard. It helps keep you in the flow of writing like a traditional text editor would. Only with a far greater range of mediums and formatting options available at your fingertips.
...
There is no universally agreed-upon list of types. Blocks come in a wide range of types, from simple presentational formatting to wildly complex components. but these editors all offer a common set of basics: text, header, image, checklist, bullet list, numbered list, callout, table, blockquote, embed, code block, divider, video, and file show up almost everywhere.
...
The way each block type works varies from app to app. Some are known for adding powerful, complex functionality into every block. While others pride themselves on simplicity; trying to stay loyal to simple text-editing traditions.

Some editors include more advanced blocks – ; enough to be a standalone app in its own right. Google Maps, Figma designs, image galleries, live coding environments, fully decked-out spreadsheets that function as relational databases. These become competitive advantages in an increasingly monoblock landscape.
...
<h3 style={{ margin: "0.25rem 0 0.5rem" }}>
  Blocks are directly manipulatable
</h3>
...
<h3 style={{ margin: "0.25rem 0 0.5rem" }}>
  Content and formatting are separate; blocks are interchangeable
</h3>
...
Coda's maker marketplace is one of the recent signs we're moving in this direct.
...
3. Blocks as end-user programming  
