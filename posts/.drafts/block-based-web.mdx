...
The places where we create these blocks have been christened _block-based editors_. Rather than treating documents as strings of styled text, these editors treat it as a stack of types blocks; each with their own formatting conventions and unique affordances:
...
You can drag and drop to move them around.

You can swap a block type for another – the content adapts to its new format.

It's easy to copy, paste, and duplicate blocks.
