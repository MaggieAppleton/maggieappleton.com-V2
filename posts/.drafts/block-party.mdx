...
Some of these applications that have a larger range of blocks have opted to put them in a persistent sidebar. This gives users a way to browse avaliable blocks in a larger area.
