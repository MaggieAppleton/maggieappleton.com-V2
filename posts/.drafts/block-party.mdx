...
The places where we create these blocks have been christened _block-based editors_. They fall into three major categories;

1. Personal and collaborative documents, including team wikis and note-taking applications
2. “No-code” website builders that help people create blog posts and simple webpages. They're starting to replace to both classical word processors and syntax-based code files.
3. Do it yourself app builders

{graphic of blocks inside a document and a no code builder}

We're now in the middle of a Cambrian explosion of these editors. Blocks are a core concept in almost every modern document editor and no-code website builder; [Notion](https://www.notion.so/), [Wordpress Gutenberg](https://wordpress.org/gutenberg/), [Coda](https://coda.io/), [Craft](https://www.craft.do/), [Clover](https://cloverapp.co/), [Almanac](https://almanac.io/), [Microsoft Loop](https://www.microsoft.com/en-us/microsoft-loop?ms.url=microsoftcommicrosoft-loop), [ClickUp](https://clickup.com/), [Google Docs](https://docs.google.com/), [Kosmik](https://www.kosmik.app/), [Retool](), [Glide](), [Roam Research](https://roamresearch.com/), [Logseq](https://logseq.com/), [Remnote](https://www.remnote.com/), [Thunknotes](https://www.thunknotes.com/), [Clarity](https://www.clarity.so/), the list goes on.
...
Some applications also have sidebars that give users a way to browse avaliable blocks in a larger area. (Coda, Retool, Wordpress Gutenberg)
