...
These blocks don't seem remarkable at this point. We've become accustomed to interfaces that allow us to whip together complex, multimedia documents in a few clicks. [Blocks are trojan horses. Except in this case the outcome isn't quite as dire as the slaughter of every Trojan warrior. It's the democratisaion of computing power. They seem harmless but are pushing forward a long sought-after dream. The dream of end-user programming.]

In short, block-based editors transfer power from developers to end-users. They are a huge force in enabling end-user programming. One that how flown under the radar. [Sentence about how blocks have enabled the democratisation of publishing rich, multimedia docusment to the web in a way that has been entirely unappreciated and unacknowledged. We are underrating blocks. We should be pointing at them and loudly acknolwedging how important they are to shifting power away from the technical elite.]

[ trojan blocks illustration ]

## The Block-based Landscape

We're now in the middle of a Cambrian explosion of these editors. Blocks are a core concept in almost every modern document editor and no-code website builder.

There's three main software 'use cases' or categories where these block-based editors are especially popular and widespread:
...
It's not just VC bois overexcitedly pouring cash into this space. Judging by the giant Notion advertisements plastered all over the London tube, block-based editors are becoming reliably mainstream.
...
<h3 style={{ margin: "0.25rem 0 0.5rem" }}>Direct manipulation</h3>



Creating, editing, and moving blocks can all be done by [direct manipulation](https://www.nngroup.com/articles/direct-manipulation/). 

Blocks lean into the design principle of  established by Ben Schneiderman in the 1980's.

If you want to change a block, you click just to the left, or you click directly
on it to drag and drop it into a new position.

You are directly touching the thing you want to change, rather than typing instructions describing the thing you want to change into a text editor or command line. [Direct manipulation](#) is one of the hallmarks of graphical user interfaces.

- Continuous representation of the object
- Physical actions to perform tasks; clicking, dragging, and gestures
...
<h5 style={{ marginTop: "-0.6rem" }}>1965-1972</h5>
...
<BasicImage width="" src="https://picsum.photos/seed/1660123560794/600/400" alt="The NLS interface" showalt />
